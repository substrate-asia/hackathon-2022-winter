...
func (c *Client) Register(ip, port string) (string, error) {
	var (
		txhash      string
		ipType      IpAddress
...
func (c *Client) Update(ip, port string) (string, error) {
	var (
		txhash      string
		ipType      IpAddress
		accountInfo types.AccountInfo
...
func (c *Client) CreateBucket(owner_pkey []byte, name string) (string, error) {
	var (
		txhash      string
		accountInfo types.AccountInfo
	)
	...
	call, err := types.NewCall(
		...
		c.MustAccountIdFromPublicKey(owner_pkey),
...
func (c *Client) DeleteBucket(owner_pkey []byte, name string) (string, error) {
	var (
		txhash      string
		accountInfo types.AccountInfo
	)
...
func (c *Client) DeclarationFile(filehash string, user UserBrief) (string, error) {
	var (
		txhash      string
		accountInfo types.AccountInfo
	)
...
func (c *Client) DeleteFile(owner_pkey []byte, filehash string) (string, error) {
	var (
		txhash      string
		accountInfo types.AccountInfo
	)
