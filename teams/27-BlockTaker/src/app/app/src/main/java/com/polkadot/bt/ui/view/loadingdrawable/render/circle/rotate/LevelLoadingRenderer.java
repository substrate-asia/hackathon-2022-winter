package com.polkadot.bt.ui.view.loadingdrawable.render.circle.rotate;
...
import com.polkadot.bt.ui.view.loadingdrawable.DensityUtil;
import com.polkadot.bt.ui.view.loadingdrawable.render.LoadingRenderer;
...
public class LevelLoadingRenderer extends LoadingRenderer {
    ...
    private static final int[] DEFAULT_LEVEL_COLORS = new int[]{Color.parseColor("#55B6915B"),
            Color.parseColor("#b1B6915B"), Color.parseColor("#ffB6915B")};
