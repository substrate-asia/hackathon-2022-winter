...
contract AVaultForArthswapFarm is Ownable, ReentrancyGuard, Pausable, ERC20Permit {
    ...
    constructor(
        ...
        withdrawFeeFactor = 9990; // 0.1% of withdraw amount, withdraw fee - return back to user pool
