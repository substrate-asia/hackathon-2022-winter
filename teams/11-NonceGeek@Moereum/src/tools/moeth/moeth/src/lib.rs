/// Moeth build version
pub const MOETH_VERSION: &str = git_hash::crate_version!();
/// Moeth short hash of the commit
pub const MOETH_HASH: &str = git_hash::git_hash_short_as_str!();
...
/// Moeth cli interface.
pub mod cli;
/// Moeth commands handler.
pub mod cmd;
/// Moeth execution context.
pub mod context;
/// Native functions.
pub mod natives;
