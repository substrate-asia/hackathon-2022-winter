...
use crate::cmd::deploy::run_moeth_package_build;
...
#[derive(Parser, Debug)]
#[clap(about = "moeth call [call] [OPTIONS]\n
    Examples:
    $ moeth call 'script_name<0x01::Dfinance::USD>([10,10], true, ADDRESS_ALIAS, SS58_ADDRESS, 100, 0x1)'
    $ moeth call 'script_name()' --args [10,10] true ADDRESS_ALIAS SS58_ADDRESS 100 0x1 --type 0x01::Dfinance::USD
    $ moeth call '0x1::Module::script_name<0x01::Dfinance::USD>()'
    $ moeth call 'script_name()' --account WALLET_KEY --gas 300
    $ moeth call 'script_name()' --secret --url https://127.0.0.1:9933 --gas 400
    $ moeth call 'script_name()' --account //Alice --gas 300
")]
