...
use sp_runtime::{
    ...
    traits::{
        AccountIdLookup, BlakeTwo256, Block as BlockT, Convert, ConvertInto, PostDispatchInfoOf,
        Dispatchable,
    },
...
mod move_vm;
mod precompiles;
pub use precompiles::MoereumPrecompiles;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    ...
    spec_name: create_runtime_str!("moereum"),
    // Name of the implementation of the spec. This is of little consequence for the node
    // and serves only to differentiate code of different implementation teams. For this
    // codebase, it _will_ be nox-polkadot.
    impl_name: create_runtime_str!("moereum"),
    authoring_version: 1,
    spec_version: 101,
    impl_version: 1,
...
impl frame_system::Config for Runtime {
    ...
    /// This is used as an identifier of the chain. 105 is the Moereum Network.
...
parameter_types! {
    pub const ExistentialDeposit: Balance = NATIVE_EXISTENTIAL_DEPOSIT;
...
/// The gas in case of Moereum and Move VM has been done in a similar way to Moonbeam EVM approach.
...
parameter_type_with_key! {
    pub ExistentialDeposits: |currency_id: CurrencyId| -> Balance {
        match currency_id {
            &CurrencyId::NATIVE => NATIVE_EXISTENTIAL_DEPOSIT,
...
/// the total EVM execution gas limit is: EVM_GAS_PER_SECOND * 0.500 * 0.75 ~= 15_000_000.
pub const EVM_GAS_PER_SECOND: u64 = 40_000_000;

/// Approximate ratio of the amount of Weight per Gas.
/// u64 works for approximations because Weight is a very small unit compared to gas.
pub const EVM_WEIGHT_PER_GAS: u64 = WEIGHT_PER_SECOND / EVM_GAS_PER_SECOND;

/// Maximum weight per block
pub const EVM_MAXIMUM_BLOCK_WEIGHT: Weight = WEIGHT_PER_SECOND / 2;

parameter_types! {
    pub BlockGasLimit: U256
        = U256::from(NORMAL_DISPATCH_RATIO * EVM_MAXIMUM_BLOCK_WEIGHT / EVM_WEIGHT_PER_GAS);
}

pub struct MoereumGasWeightMapping;

impl pallet_evm::GasWeightMapping for MoereumGasWeightMapping {
    fn gas_to_weight(gas: u64) -> Weight {
        gas.saturating_mul(EVM_WEIGHT_PER_GAS)
    }
    fn weight_to_gas(weight: Weight) -> u64 {
        weight.wrapping_div(EVM_WEIGHT_PER_GAS)
    }
}
...
parameter_types! {
    pub PrecompilesValue: MoereumPrecompiles<Runtime> = MoereumPrecompiles::<_>::new();
}
...
impl pallet_evm::Config for Runtime {
    ...
    type PrecompilesType = MoereumPrecompiles<Runtime>;
