...
use moereum_runtime::{
    ...
    DemocracyConfig, PolkadotXcmConfig, EligibilityValue, EvmConfig, EthereumConfig,
    EthereumChainIdConfig, GenesisAccount,
};
        ...
        move || {
            genesis(
                ...
                vec![
                    ...
                    // Goliath
                    H160::from(hex_literal::hex![
                        "7BF369283338E12C90514468aa3868A551AB2929"
                    ]),
                    // Heath
                    H160::from(hex_literal::hex![
                        "931f3600a299fd9B24cEfB3BfF79388D19804BeA"
                    ]),
                    // Ida
                    H160::from(hex_literal::hex![
                        "C41C5F1123ECCd5ce233578B2e7ebd5693869d73"
                    ]),
                    // Judith
                    H160::from(hex_literal::hex![
                        "2898FE7a42Be376C8BC7AF536A940F7Fd5aDd423"
                    ]),
                ],
            )
        },
...
pub fn genesis(
    ...
    let pont_framework =
        include_bytes!("../../move/moereum-stdlib/build/MoereumStdlib/bundles/MoereumStdlib.pac")
            .to_vec();
