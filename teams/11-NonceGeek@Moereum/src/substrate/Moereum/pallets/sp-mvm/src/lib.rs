...
//! Read more about scripts and modules in Moereum documentation - https://docs.moereum.network/03.-move-vm/modules
...
pub mod pallet {
        ...
        OriginFor<T>: Into<Result<groupsign::Origin<T>, OriginFor<T>>>,
    {
        ...
        /// Publish module package (could be generated using 'dove deploy'), e.g.: several modules in one transaction.
        ///
        /// Deploy several modules in one transaction. Could be called by root in case needs to update Standard Library.
        /// Read more about Standard Library - https://docs.moereum.network/03.-move-vm/stdlib
        /// The gas limit should be provided.
    ...
    pub struct GenesisConfig<T: Config> {
        ...
        /// Moereum Framework library bytes.
    ...
    impl<T: Config> GenesisBuild<T> for GenesisConfig<T> {
        fn build(&self) {
            ...
            let pont_framework_package = ModulePackage::try_from(&self.pont_framework[..])
                .expect("Failed to parse moereum framework lib");
