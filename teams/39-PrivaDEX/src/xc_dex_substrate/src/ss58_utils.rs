/**
 * This is just a copy of portions of https://github.com/paritytech/substrate/blob/master/primitives/core/src/crypto.rs
 * That file unfortunately hides some functionality under std and full_crypto features,
 * which we cannot use. Hence we copy it here for our use
 */
