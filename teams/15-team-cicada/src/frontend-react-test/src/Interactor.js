...
function Main(props) {
  ...
  const updateParamFields = () => {
    ...
    if (interxType === 'QUERY') {
      ...
      console.log("effect args:", metaArgs)
      ...
      console.log("effect paramFields:", paramFields)
    } else if (interxType === 'RPC') {
      let metaParam = []
  ...
  const onPalletCallableParamChange = (_, data) => {
    setFormState(formState => {
      let res
      console.log("onPalletCallableParamChange data:", data, formState)
      const { state, value } = data
      if (typeof state === 'object') {

        console.log("onPalletCallableParamChange state:", state)
