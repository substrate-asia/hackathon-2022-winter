...
<!-- MarkdownTOC -->
* [类别 1：构建平行链 + 独立链](#类别-1构建平行链--独立链)
    * [游戏链](#游戏链)
    * [DeFi 或 稳定币链](#defi-或-稳定币链)
    * [隐私链](#隐私链)
    * [DAO 链](#dao-链)
    * [内容、社交网络、存储链](#内容社交网络存储链)
    * [去中心化身份链 (DId)](#去中心化身份链-did)
    * [去中心化市场链](#去中心化市场链)
    * [其它想法](#其它想法)
* [类别 2：智能合约（相关）](#类别-2智能合约相关)
    * [智能合约链](#智能合约链)
    * [智能合约平台](#智能合约平台)
* [类别 3：区块链工具](#类别-3区块链工具)
    * [测试套件](#测试套件)
    * [可视化](#可视化)
    * [治理工具](#治理工具)
    * [数据分析工具](#数据分析工具)
...
尽一切可能去尝试！在这个类别中，我们希望你能突破可能的极限，要有创造力、打破事物。完善 Web3 底层技术，如点对点通信框架如 libp2p，基于 Substrate 新的共识算法，节点路由和查找如DHT，以及其它可以用来帮助点对点的金融、社交活动。基于substrate轻节点的应用，UI对新的governance V2的支持等等。